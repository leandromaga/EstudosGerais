...
class Professor(Pessoa):
    ...
    def __init__(self,nome, titulacaoMaxima):
...
class AlunoEnsinoMedio(Aluno):
    ...
    def calcularSituacao(self):
        if ((self._notaProva1 + self._notaProva2) / 2) >= 6:
            return "Aprovado"
        else:
            return "Reprovado"
...
class AlunoGraduacao(Aluno):
    ...
    def calcularSituacao(self):
        if ((self._notaProva1 + self._notaProva2) / 2) >= 7:
            return "Aprovado"
        else:
            return "Reprovado"
...
print("Situação do aluno = " + alunoEM1.calcularSituacao())
...
print("Situação do aluno = " + alunoGraducao.calcularSituacao())
